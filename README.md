...
При создании объектов моделей Author, что-то упустил и далее по заданию получилось выполнить только для одного автора. Продлевал срок по данному модулю 3 раза после разморозки обучения. Сегодня истекает третий срок. Сдаю проект с ошибкой, но этот вопрос изучу и исправлю для себя чуть позже.
